			...
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					...
					<div class="wizard-content">
						<form class="tab-wizard wizard-circle wizard vertical" action="ajouter_commande.php" method="post" >
							<h5 class="text-blue h4">Ajouter Commande de vente</h5>
							<section>
							...
							<div class="col-md-6 col-sm-12 mb-30">
								<!-- <div class="pd-20 card-box height-100-p"> -->
									...
									<a href="#" class="btn-block " data-toggle="modal" data-target="#edit" type="button">
										<button type="button" class="btn btn-lg btn-outline-dark" data-dismiss="modal">Ajouter produits</button>
									</a>
										...
										<div class="modal-dialog modal-xl modal-dialog-centered">
											<div class="modal-content">
												<div class="modal-header">
													<h4 class="modal-title" id="myLargeModalLabel">Produits</h4>
													...
													<div class="">
														<div class="">
															...
															<div class="card-box mb-30">
																<h2 class="h4 pd-20">Selectionner les produits</h2>
																					...
																					<tr class="text-center">
																						...
																						<td><div class="row">
																							<div class="col-md-12 col-sm-12">
																								<div class="form-group">
																										<input  id="number" style="display:none" class="form-control" type="number" placeholder="0" name="quantiti_commande[]" min="0" max="<?=$row->__get("quantite_stock")?>">
