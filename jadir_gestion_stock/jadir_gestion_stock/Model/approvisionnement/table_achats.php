 ...
 <div class="main-container">
	 <div class="pd-ltr-20">
		 ...
		 <div class="card-box mb-30">
			 <h2 class="h4 pd-20">Table des achats</h2>
									 ...
									 <td>
										 <div class="dropdown">
											 ...
											 <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
												 <a class="dropdown-item" href="facture_achat.php?num_commande=<?=$row->__get("numero_commande")?>"><i class="dw dw-eye"></i> View</a>
											 </div>
										 </div>
									 </td>
								 </tr>
